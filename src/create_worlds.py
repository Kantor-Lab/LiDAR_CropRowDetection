...
def create_sdf_world(num_rows, bushes_per_row, bush_spacing, row_spacing):
    ...
    def create_bush_model(bush_id, x, y, z, scale):
        ...
        # ET.SubElement(mesh, 'scale').text = f'{0.0002} {0.0001} {0.0002}'
    ...
    tree.write('/home/ruijiliu/catkin_ws/src/iowa_navigation/worlds/test_mature_soybean.world', encoding='utf-8', xml_declaration=False)
    print("finished")
...
if __name__ == "__main__":
    ...
    create_sdf_world(num_rows=4, bushes_per_row=100, bush_spacing=0.5, row_spacing=0.762)
